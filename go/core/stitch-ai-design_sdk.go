...
func (sdk *StitchAiDesignSDK) OptionsMap() map[string]any {
...
func (sdk *StitchAiDesignSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StitchAiDesignSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StitchAiDesignSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StitchAiDesignSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StitchAiDesignSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StitchAiDesignSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StitchAiDesignSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StitchAiDesignSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StitchAiDesignSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StitchAiDesignSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *StitchAiDesignSDK {
	...
	sdk := NewStitchAiDesignSDK(sdkopts)
	sdk.Mode = "test"
