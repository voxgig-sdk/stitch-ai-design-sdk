...
func registerSDKWords(r *eng.Registry, client *sdk.StitchAiDesignSDK) {
...
func runOp(client *sdk.StitchAiDesignSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
