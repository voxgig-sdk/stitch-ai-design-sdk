...
// StitchAiDesign SDK streaming feature
...
class StitchAiDesignStreamingFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _iterate(StitchAiDesignResult $result): \Generator
    {
    ...
    private function _streamable(StitchAiDesignContext $ctx): bool
    {
