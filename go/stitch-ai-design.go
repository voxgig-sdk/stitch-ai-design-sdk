...
// instead of `sdk.NewStitchAiDesignSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *StitchAiDesignSDK  { return NewStitchAiDesignSDK(nil) }
func Test() *StitchAiDesignSDK { return TestSDK(nil, nil) }
