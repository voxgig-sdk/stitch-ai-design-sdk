...
// StitchAiDesign SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StitchAiDesignSDK::test)
...
{
    private const SDK_CLASS = 'StitchAiDesignSDK';
    ...
    private const SDK_BASE = 'stitchaidesign_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../stitchaidesign_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
