...
// StitchAiDesign SDK metrics feature
...
class StitchAiDesignMetricsFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _record(StitchAiDesignContext $ctx, bool $ok): void
    {
