...
func NewDesignGenerationEntity(client *core.StitchAiDesignSDK, entopts map[string]any) *DesignGenerationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DesignGenerationEntity) GetName() string { return e.name }
...
func (e *DesignGenerationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DesignGenerationEntity) Deleted() bool {
	return e.deleted
}


func (e *DesignGenerationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDesignGenerationEntity(e.client, opts)
}

func (e *DesignGenerationEntity) Data(args ...any) any {
...
func (e *DesignGenerationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DesignGeneration; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DesignGenerationEntity) DataTyped(data ...DesignGeneration) DesignGeneration {
	if len(data) > 0 {
		return typedFrom[DesignGeneration](e.Data(asMap(data[0])))
	}
	return typedFrom[DesignGeneration](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DesignGeneration (all fields
// optional at the wire level).
func (e *DesignGenerationEntity) MatchTyped(match ...DesignGeneration) DesignGeneration {
	if len(match) > 0 {
		return typedFrom[DesignGeneration](e.Match(asMap(match[0])))
	}
	return typedFrom[DesignGeneration](e.Match())
}
...
func (e *DesignGenerationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DesignGenerationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DesignGenerationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DesignGenerationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DesignGenerationCreateData and returns an DesignGeneration. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DesignGenerationEntity) CreateTyped(reqdata DesignGenerationCreateData, ctrl map[string]any) (DesignGeneration, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DesignGeneration{}, err
	}
	return typedFrom[DesignGeneration](res), nil
}



func (e *DesignGenerationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DesignGenerationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DesignGenerationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
