...
// StitchAiDesign SDK ratelimit feature
...
class StitchAiDesignRatelimitFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _acquire(StitchAiDesignContext $ctx): void
    {
    ...
    private function _track(StitchAiDesignContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
