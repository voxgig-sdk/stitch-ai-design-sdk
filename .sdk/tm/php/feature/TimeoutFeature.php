...
// StitchAiDesign SDK timeout feature
...
class StitchAiDesignTimeoutFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _with_timeout(StitchAiDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StitchAiDesignContext $_ctx, float $ms): void
    {
        $client = $this->client;
