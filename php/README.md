# StitchAiDesign PHP SDK



The PHP SDK for the StitchAiDesign API — an entity-oriented client using PHP conventions.
...
```
php/
├── stitchaidesign_sdk.php          -- Main SDK class
...
The main class (`stitchaidesign_sdk.php`) exports the SDK class
