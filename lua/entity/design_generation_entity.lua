...
local DesignGenerationEntity = {}
DesignGenerationEntity.__index = DesignGenerationEntity


function DesignGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DesignGenerationEntity)
  self._name = "design_generation"
  self._client = client
...
function DesignGenerationEntity:get_name()
  return self._name
end


function DesignGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DesignGenerationEntity.new(self._client, opts)
end
...
function DesignGenerationEntity:mark_deleted()
  self._deleted = true
end


function DesignGenerationEntity:deleted()
  return true == self._deleted
end


function DesignGenerationEntity:data_set(args)
  if args ~= nil then
...
function DesignGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DesignGenerationEntity:match_set(args)
  if args ~= nil then
...
function DesignGenerationEntity:match_get()
...
function DesignGenerationEntity:stream(action, args, callopts)
...
function DesignGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
