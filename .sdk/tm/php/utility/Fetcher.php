...
// StitchAiDesign SDK utility: fetcher

class StitchAiDesignFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StitchAiDesignSDK/1.0)';
    ...
    public static function call(StitchAiDesignContext $ctx, string $fullurl, array $fetchdef): array
    {
