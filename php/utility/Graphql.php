...
// StitchAiDesign SDK utility: graphql
//
...
class StitchAiDesignGraphql
{
    ...
    // equivalent.
    public static function body(StitchAiDesignContext $ctx): mixed
    {
    ...
    public static function errors(StitchAiDesignContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
