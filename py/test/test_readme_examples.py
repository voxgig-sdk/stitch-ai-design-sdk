# StitchAiDesign SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StitchAiDesignSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StitchAiDesignSDK(...) and StitchAiDesignSDK.test(...) become
#      StitchAiDesignSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stitchaidesign_sdk"
_SDK_CLASS = "StitchAiDesignSDK"
