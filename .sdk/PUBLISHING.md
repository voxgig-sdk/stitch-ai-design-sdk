...
|---|---|---|
| `ts/` | @voxgig-sdk/stitch-ai-design-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/stitch-ai-design-sdk \
      --repository voxgig-sdk/stitch-ai-design-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/stitch-ai-design-sdk` shows it, and
`npm trust revoke @voxgig-sdk/stitch-ai-design-sdk --id=<id>` removes it.
