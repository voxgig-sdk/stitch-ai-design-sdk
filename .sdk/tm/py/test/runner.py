...
class StitchAiDesignTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StitchAiDesignTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StitchAiDesignTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StitchAiDesignTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
