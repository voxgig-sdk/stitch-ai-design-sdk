...
// StitchAiDesign SDK rbac feature
...
class StitchAiDesignRbacFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _required(StitchAiDesignContext $ctx): ?string
    {
    ...
    private function _reject(StitchAiDesignContext $ctx, string $required): void
    {
    ...
    private function _track(StitchAiDesignContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
