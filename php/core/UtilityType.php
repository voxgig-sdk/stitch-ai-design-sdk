...
// StitchAiDesign SDK utility type

class StitchAiDesignUtility
{
    ...
    public static function copy(StitchAiDesignUtility $src): StitchAiDesignUtility
    {
        $u = new StitchAiDesignUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
