...
// StitchAiDesign SDK cache feature
...
class StitchAiDesignCacheFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _through(StitchAiDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
