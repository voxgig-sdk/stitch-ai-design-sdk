...
// StitchAiDesign SDK telemetry feature
...
class StitchAiDesignTelemetryFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _close(StitchAiDesignContext $ctx, bool $ok): void
    {
