...
#      offline in seeded test mode (StitchAiDesignSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "StitchAiDesign_sdk.rb")
  SDK_CLASS = "StitchAiDesignSDK"
