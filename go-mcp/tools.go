...
type Args struct {
	Entity string         `json:"entity" jsonschema:"design_generation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StitchAiDesignSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "stitch-ai-design_list",
		Description: "List records from StitchAiDesign. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "stitch-ai-design_load",
		Description: "Load a single record from StitchAiDesign. " +
...
func runOp(client *sdk.StitchAiDesignSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StitchAiDesignSDK, name string) (sdk.StitchAiDesignEntity, error) {
	switch strings.ToLower(name) {
	case "design_generation":
		return client.DesignGeneration(nil), nil
