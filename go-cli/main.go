// Command StitchAiDesign-cli is a CLI + REPL for the StitchAiDesign SDK,
...
const prompt = "stitch-ai-design"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "design_generation"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      STITCH_AI_DESIGN_APIKEY (api key), STITCH_AI_DESIGN_BASE (base url override)")
