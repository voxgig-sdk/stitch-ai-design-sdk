// Command StitchAiDesign-mcp is an MCP server exposing the StitchAiDesign
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StitchAiDesign_list  — list records of an entity
//	StitchAiDesign_load  — load a single record of an entity
//
