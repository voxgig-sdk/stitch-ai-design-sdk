...
from stitchaidesign_sdk.stitchaidesign_types import (
    DesignGeneration,
...
class DesignGenerationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DesignGenerationEntity(self._client, opts)
    ...
    def data_get(self) -> DesignGeneration:
    ...
    def match_get(self) -> DesignGeneration:
    ...
    def create(self, reqdata: DesignGenerationCreateData, ctrl=None) -> DesignGeneration:
        utility = self._utility
