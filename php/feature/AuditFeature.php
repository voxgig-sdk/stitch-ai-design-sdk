...
// StitchAiDesign SDK audit feature
...
class StitchAiDesignAuditFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _emit(StitchAiDesignContext $ctx, string $outcome): void
    {
