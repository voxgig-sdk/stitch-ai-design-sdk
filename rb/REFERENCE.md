# StitchAiDesign Ruby SDK Reference

Complete API reference for the StitchAiDesign Ruby SDK.
...
#### `StitchAiDesignSDK.test(testopts = nil, sdkopts = nil)`
