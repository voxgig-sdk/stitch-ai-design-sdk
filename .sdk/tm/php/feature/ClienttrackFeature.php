...
// StitchAiDesign SDK clienttrack feature
...
class StitchAiDesignClienttrackFeature extends StitchAiDesignBaseFeature
{
    ...
    public function PostConstruct(StitchAiDesignContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StitchAiDesign-SDK';
