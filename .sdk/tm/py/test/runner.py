...
class StitchAiDesignTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StitchAiDesignTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StitchAiDesignTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StitchAiDesignTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
