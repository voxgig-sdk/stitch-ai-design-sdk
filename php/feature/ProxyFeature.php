...
// StitchAiDesign SDK proxy feature
...
class StitchAiDesignProxyFeature extends StitchAiDesignBaseFeature
{
    ...
    public function init(StitchAiDesignContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StitchAiDesignContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
