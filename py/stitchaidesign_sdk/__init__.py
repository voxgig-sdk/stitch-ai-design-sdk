...
from stitchaidesign_sdk.utility import register

# Load features
from stitchaidesign_sdk.feature.base_feature import StitchAiDesignBaseFeature
from stitchaidesign_sdk.features import _has_feature, _make_feature
...
class StitchAiDesignSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = StitchAiDesignUtility()
        self._utility = utility

        from stitchaidesign_sdk.config import shared_config
    ...
    def get_utility(self):
        return StitchAiDesignUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StitchAiDesignSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DesignGeneration(self, data=None) -> "DesignGenerationEntity":
        ...
        from stitchaidesign_sdk.entity.design_generation_entity import DesignGenerationEntity
