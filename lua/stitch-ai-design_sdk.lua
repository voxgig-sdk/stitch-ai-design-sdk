...
require("stitch-ai-design_types")
...
local StitchAiDesignSDK = {}
StitchAiDesignSDK.__index = StitchAiDesignSDK
...
StitchAiDesignSDK._make_feature = _make_feature


function StitchAiDesignSDK.new(options)
  local self = setmetatable({}, StitchAiDesignSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function StitchAiDesignSDK:options_map()
...
function StitchAiDesignSDK:get_utility()
  return Utility.copy(self._utility)
end


function StitchAiDesignSDK:get_root_ctx()
  return self._rootctx
end


function StitchAiDesignSDK:prepare(fetchargs)
...
function StitchAiDesignSDK:direct(fetchargs)
...
-- by passing it.
function StitchAiDesignSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function StitchAiDesignSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "StitchAiDesignSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function StitchAiDesignSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = StitchAiDesignSDK.new(sdkopts)
  sdk.mode = "test"
