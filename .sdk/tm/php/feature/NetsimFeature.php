...
// StitchAiDesign SDK netsim feature
...
class StitchAiDesignNetsimFeature extends StitchAiDesignBaseFeature
{
    ...
    private function _simulate(StitchAiDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StitchAiDesignContext $ctx, array $applied): void
    {
        $client = $this->client;
